  ...
  return (
    <div className="page-enter pb-8">
      ...
      <div className="flex flex-col gap-4">
            ...
            <div style={{ borderTop: '1px solid #F0F0ED' }}>
              ...
              <div className="flex items-center justify-between" style={{ padding: '14px 20px 8px' }}>
                ...
                <div className="flex items-center gap-2">
                  <span style={{
                    fontSize: 12, fontWeight: 600, color: '#5A6577',
                    background: '#F0F0ED', borderRadius: 6, padding: '3px 8px',
                  }}>
              ...
              {todayRecords.map((record, i) => {
                ...
                return (
                  <div key={record.id}
                    ...
                    {/* 時刻 */}
                    <span style={{
                      fontSize: 14, fontWeight: 600, color: '#5A6577',
                    ...
                    {/* スコア */}
                    <span style={{
                      fontSize: 18, fontWeight: 700, color: '#2D3748',
                      flexShrink: 0, fontVariantNumeric: 'tabular-nums',
                    }}>
                      {record.score}
                      <span style={{ fontSize: 12, fontWeight: 400, color: '#8896A6' }}>/100</span>
                    </span>
                  </div>
                );
              })}
        ...
        <button onClick={() => navigate('/chat')} className="w-full m3-state rounded-[16px]"
                style={{ height: 48, background: '#FDE8D0', color: '#3D2800', fontSize: 15, fontWeight: 600, border: 'none', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
